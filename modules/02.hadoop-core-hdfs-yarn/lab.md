...
1. Create a directory named after your `$USER` in your group HDFS directory. E.g. `/education/dsti_2022_spring/$USER`
...
1. Look at the content of the input directory we will use: `/education/dsti_2022_spring/resources/lab2`
2. Run the command:
   ```bash
   yarn jar /usr/hdp/3.1.0.0-78/hadoop-mapreduce/hadoop-mapreduce-examples-3.1.1.3.1.0.0-78.jar \
    wordcount /education/dsti_2022_spring/resources/lab2 \
    /education/dsti_2022_spring/$USER/lab2/output-moby-dick
   ```
